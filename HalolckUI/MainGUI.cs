...
namespace HalolckUI
{
    public partial class DesignMain : Form
    {
        ...
        private void Init()
        {
            ESPColorCombo.ForeColor = Color.White;
        ...
        {
            ABSValLbl.Text = ABSSlider.L_Value.ToString();
            f_Overlay.AimbotSmooth = ABSSlider.L_Value;
        }

        private void slider2_LValueChanged(object sender, CustomSlider.LEventArgs e)
        {
            FBSBalLbl.Text　= FBSSlider.L_Value.ToString();
            f_Overlay.FlickSmooth = FBSSlider.L_Value;
        }
        ...
        private void toggleCheckbox2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            f_Overlay.FlickEnable = FBToggle.Checked;
            FBSSlider.L_Enable = FBToggle.Checked;
        }
        ...
        private void toggleCheckbox3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            f_Overlay.SilentEnable = SAToggle.Checked;
        }
        ...
        private void ESPColorCombo_DropDownClosed(object sender, EventArgs e)
        {
            this.ActiveControl = null;
        }
